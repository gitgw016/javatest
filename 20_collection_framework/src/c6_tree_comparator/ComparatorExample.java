...
public class ComparatorExample {
	...
	public static void main(String[] args) {
		...
		treeSet.add(new Fruit("배밍",3000));
		treeSet.add(new Fruit("구민",1500));
		treeSet.add(new Fruit("민구",10000));
		System.out.println(treeSet);
		
		System.out.println("[Comparator 구현 객체]");
		TreeSet<Fruit> treeSet2 = null;
		treeSet2 = new TreeSet<>(new DescendingFruitComparator());
		treeSet2.add(new Fruit("배밍",3000));
		treeSet2.add(new Fruit("구민",1500));
		treeSet2.add(new Fruit("민구",10000));
		...
		treeSet3.add(new Fruit("배밍",3000));
		treeSet3.add(new Fruit("구민",1500));
		treeSet3.add(new Fruit("민구",10000));
